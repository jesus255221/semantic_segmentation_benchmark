...
def unet(pretrained_weights = None, input_size = (256, 256, 3), classes = 1):
    ...
    bn3 = KL.BatchNormalization()(conv3)
    ...
    bn4 = KL.BatchNormalization()(conv4)
    drop4 = KL.Dropout(0.5)(bn4)
    ...
    bn5 = KL.BatchNormalization()(conv5)
    drop5 = KL.Dropout(0.5)(bn5)

    up6 = KL.Conv2D(512, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(KL.UpSampling2D(size = (2,2))(drop5))
    upbn6 = KL.BatchNormalization()(up6)
    merge6 = KL.concatenate([drop4, upbn6], axis = 3)
    ...
    bn6 = KL.BatchNormalization()(conv6)

    up7 = KL.Conv2D(256, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(KL.UpSampling2D(size = (2,2))(bn6))
    upbn7 = KL.BatchNormalization()(up7)
    merge7 = KL.concatenate([conv3, upbn7], axis = 3)
    ...
    bn7 = KL.BatchNormalization()(conv7)
    

    up8 = KL.Conv2D(128, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(KL.UpSampling2D(size = (2,2))(bn7))
    upbn8 = KL.BatchNormalization()(up8)
    merge8 = KL.concatenate([conv2, upbn8], axis = 3)
    ...
    bn8 = KL.BatchNormalization()(conv8)

    up9 = KL.Conv2D(64, 2, activation = 'relu', padding = 'same', kernel_initializer = 'he_normal')(KL.UpSampling2D(size = (2,2))(bn8))
    upbn9 = KL.BatchNormalization()(up9)
    merge9 = KL.concatenate([conv1, upbn9], axis = 3)
    ...
    bn9 = KL.BatchNormalization()(conv9)
    conv9 = KL.Conv2D(classes, 1, activation = 'softmax', padding = 'same', kernel_initializer = 'he_normal')(bn9)
...
## Commom loss function for segmentation task
## source code from https://github.com/killthekitten/kaggle-carvana-2017/blob/master/losses.py
...
def dice_coef_loss_bce(y_true, y_pred, dice=0.75, bce=0.25, bootstrapping='hard', alpha=1.):
